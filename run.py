...
TABLE = [
    ...
    {'col':6 , 'text':'BRIGE?', 'size':9, 'edit': False, 'disabled': False, 'key': 'bridge', 'tip': 'If selected, a bridge will be drawn between the terminal and the next one'},
    ...
    {'col':8 , 'text':'HOSE', 'size':9, 'edit': True, 'disabled': False, 'key': 'hose', 'tip': "Hose's name the conductor belongs to. Several terminals can share hose (i.e. -W1, -WXL12,...)"},
...
window = sg.Window(TITLE, layout, icon = ICON,  resizable=True, size=(960,500))
