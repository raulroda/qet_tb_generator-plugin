...
Plugin para Qelectrotech que permite generar borneros para los esquemas eléctricos. 
...
3. Actualizar numero de version en setup.py y en main.py para caption del form.
